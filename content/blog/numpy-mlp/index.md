---js
const title = "Intuition pour la backpropagation - MLP avec numpy sur MNIST";
const description = "Intuition et calcul différentiel pour la backpropagation automatique de gradient - MLP avec numpy pour MNIST";
